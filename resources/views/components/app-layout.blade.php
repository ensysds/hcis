...
<head>
    ...
    <link href="{{ asset('assets/vendor/bootstrap/bootstrap.min.css') }}?v={{ $assetVersion('assets/vendor/bootstrap/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/vendor/bootstrap-icons/bootstrap-icons.min.css') }}?v={{ $assetVersion('assets/vendor/bootstrap-icons/bootstrap-icons.min.css') }}" rel="stylesheet">
...
<script src="{{ asset('assets/vendor/bootstrap/bootstrap.bundle.min.js') }}?v={{ $assetVersion('assets/vendor/bootstrap/bootstrap.bundle.min.js') }}"></script>
